...
export default function Product(props: Item) {
  const { name, description, modelFileName, likes, dislikes } = props;
  return (
    <li className="w-[21rem] bg-gray-200 p-4">
      {/* <Image src="/images/product1.jpg" width={300} height={300} alt="Product 1" /> */}
      ...
      <div className="flex justify-end gap-2">
        <button className="py-1.5 px-3 hover:text-blue-600 hover:scale-105 hover:shadow text-center border border-gray-300 rounded-md border-gray-400 h-8 text-sm flex items-center gap-1 lg:gap-2">
